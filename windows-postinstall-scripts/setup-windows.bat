...
setx TEMP C:\TEMP & setx TEMP C:\TEMP /m
setx TMP C:\TEMP & setx TMP C:\TEMP /m
cd /d "%~dp0"
reg import win7-pro-registry-tweaks.reg
...
setx TMP C:\TEMP & setx TMP C:\TEMP /m
cd /d "%~dp0"
reg import win10-ltsc-21h2-registry-tweaks.reg
